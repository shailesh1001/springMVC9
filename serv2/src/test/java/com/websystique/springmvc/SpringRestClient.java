...
public class SpringRestClient {
    ...
    public static final String REST_SERVICE_URI = "http://localhost:8086/SpringSecurityOAuth2Example";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8086/SpringSecurityOAuth2Example/oauth/token";
